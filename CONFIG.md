...
**Example:**
```sh
export GRUB_KERNEL_CMDLINE="intel_iommu=igfx_off iommu.strict=1 i915.enable_dc=0 i915.modeset=1 i915.enable_psr=0 intel_idle.max_cstate=1"
```
...
**Example:**
```sh
export NEXTDNS_STAMP="sdns://AgcAAAAAAAAA..."
```
